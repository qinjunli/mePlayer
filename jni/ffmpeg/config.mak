...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --enable-version3 --enable-gpl --enable-nonfree --disable-stripping --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-ffprobe --disable-encoders --disable-muxers --disable-devices --disable-protocols --enable-protocol=file --enable-protocol=HTTP --enable-avfilter --enable-network --disable-avdevice --enable-cross-compile --cc=/cygdrive/f/android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/bin/arm-eabi-gcc --cross-prefix=/cygdrive/f/android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/bin/arm-eabi- --nm=/cygdrive/f/android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/bin/arm-eabi-nm --extra-cflags='-fPIC -DANDROID' --disable-asm --enable-neon --enable-armv5te --extra-ldflags='-Wl,-T,/cygdrive/f/android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/arm-eabi/lib/ldscripts/armelf.x -Wl,-rpath-link=/cygdrive/f/android/android-ndk-r4/build/platforms/android-8/arch-arm/usr/lib -L/cygdrive/f/android/android-ndk-r4/build/platforms/android-8/arch-arm/usr/lib -nostdlib /cygdrive/f/android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtbegin.o /cygdrive/f/android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtend.o -lc -lm -ldl'
prefix=/usr/local
...
SRC_PATH="/cygdrive/d/android-project/jni/ffmpeg"
SRC_PATH_BARE=/cygdrive/d/android-project/jni/ffmpeg
BUILD_ROOT="/cygdrive/d/android-project/jni/ffmpeg"
ARCH=c
CC=/cygdrive/f/android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/bin/arm-eabi-gcc
AS=/cygdrive/f/android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/bin/arm-eabi-gcc
LD=/cygdrive/f/android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/bin/arm-eabi-gcc
DEPCC=/cygdrive/f/android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/bin/arm-eabi-gcc
YASM=yasm
YASMDEP=yasm
AR=/cygdrive/f/android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/bin/arm-eabi-ar
RANLIB=/cygdrive/f/android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/bin/arm-eabi-ranlib
CP=cp -p
LN_S=ln -sf
...
CC_O=-o $@
DLLTOOL=
LDFLAGS=  -Wl,-T,/cygdrive/f/android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/arm-eabi/lib/ldscripts/armelf.x -Wl,-rpath-link=/cygdrive/f/android/android-ndk-r4/build/platforms/android-8/arch-arm/usr/lib -L/cygdrive/f/android/android-ndk-r4/build/platforms/android-8/arch-arm/usr/lib -nostdlib /cygdrive/f/android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtbegin.o /cygdrive/f/android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtend.o -lc -lm -ldl -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
