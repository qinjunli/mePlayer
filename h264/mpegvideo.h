...
//    ParseContext parse_context;  //del lb--11-03-05
...
//void ff_write_quant_matrix(PutBitContext *pb, uint16_t *matrix);  //del lb--11-03-06
...
//int ff_mpeg1_find_frame_end(ParseContext *pc, const uint8_t *buf, int buf_size, AVCodecParserContext *s); //del lb--11-03-05
*/
