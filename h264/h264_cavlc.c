...
//    tprintf(h->s.avctx, "pred_nnz L%X T%X n%d s%d P%X\n", left, top, n, scan8[n], i&31);//del lb--11-03-04
...
//    tprintf(h->s.avctx,"trailing:%d, total:%d\n", trailing_ones, total_coeff);//del lb--11-03-04
...
//    av_log(s->avctx,"pic:%d mb:%d/%d\n", h->frame_num, s->mb_x, s->mb_y);//del lb--11-03-04
