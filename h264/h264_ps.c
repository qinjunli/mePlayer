...
//    unsigned int aspect_ratio_idc; //del lb--11-03-06
...
*/		//de lb--11-03-05
    ...
    if(s->avctx->debug&FF_DEBUG_PICT_INFO){
        av_log(h->s.avctx, AV_LOG_DEBUG, "sps:%u profile:%d/%d poc:%d ref:%d %dx%d %s %s crop:%d/%d/%d/%d %s %s %d/%d\n",
               ...
               /*((const char*[]){*/"Gray"/*,"420","422","444"})[sps->chroma_format_idc]*/,  //update lb--11-03-03
