...
//add lb--11-03-03
/////////////////////////////////////////
#define PIX_FMT_NB            50    // Numbers×Ô¶¨Òå
...
//#define CODEC_FLAG_TRUNCATED       0x00010000 /** Input bitstream might be truncated at a randomlocation instead of only at frame boundaries. */
...
typedef struct AVCodecContext {
     ...
     */
//    const AVClass *av_class;  //del lb--11-03-05
    /**
     * the average bitrate
...
*/
     ...
     * - decoding: Set by libavcodec.
     */
//    AVRational time_base;//del lb--11-03-05
...
#define FF_ASPECT_EXTENDED 15
    ...
    /* audio only */
//    int sample_rate; ///< samples per second  //del lb--11-03-11
     ...
     * - decoding: Set by libavcodec.
     */
//    enum AVSampleFormat sample_fmt;  ///< sample format   //del lb--11-03-05
...
*/
     ...
     * - decoding: unused
     */
//    RcOverride *rc_override;  //del lb--11-03-05
...
*/
     ...
     * - decoding: Set by libavcodec.
     */
//    AVRational sample_aspect_ratio;//del lb--11-03-05
 ...
 */
//attribute_deprecated int av_parse_video_frame_rate(AVRational *frame_rate, const char *str); //del lb--11-03-05
//#endif
...
inline av_const int mid_pred(int a, int b, int c);
